...
const HELP =
  "Use the menu to add cards, review what’s due, check your progress, and adjust your routine.\n\n" +
  "During review, reveal the answer, then choose the rating that feels honest. VocabSprint schedules the next review for you.";
